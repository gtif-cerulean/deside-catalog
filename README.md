...
The static catalog itself is available [online](https://gtif-cerulean.github.io/deside-catalog/deside/catalog.json) and can easily be viewed for example in the [STAC browser](https://browser.moregeo.it/external/gtif-cerulean.github.io/deside-catalog/deside/catalog.json).
